import {r as lr, a as S} from "./vendor-APaRTBvJ.js";
var Jt = {
    exports: {}
}
  , pt = {};
...
function ur() {
    ...
    function r(a, l, u) {
        ...
        for (c in l)
            s.call(l, c) && !o.hasOwnProperty(c) && (h[c] = l[c]);
        if (a && a.defaultProps)
...
const Ee = typeof window < "u"
  , fr = Ee ? S.useLayoutEffect : S.useEffect
...
class Oe {
    ...
    add(e) {
        return Fe(this.subscriptions, e),
        () => Be(this.subscriptions, e)
    }
    notify(e, n, s) {
...
const pr = ke( () => window.ScrollTimeline !== void 0);
class gr {
    constructor(e) {
...
const _e = t => Array.isArray(t) && typeof t[0] == "number"
  , vr = {
    linearEasing: void 0
};
function xr(t, e) {
    ...
    return () => {
        var s;
        return (s = vr[e]) !== null && s !== void 0 ? s : n()
    }
}
const Nt = xr( () => {
    try {
...
;
function Is(t) {
    return !!(typeof t == "function" && Nt() || !t || typeof t == "string" && (t in de || Nt()) || _e(t) || Array.isArray(t) && t.every(Is))
}
...
function js(t, e) {
    if (t)
        return typeof t == "function" && Nt() ? Os(t, e) : _e(t) ? yt(t) : Array.isArray(t) ? t.map(n => js(n, e) || de.easeOut) : de[t]
}
const Bt = ["read", "resolveKeyframes", "update", "preRender", "render", "postRender"]
  , pn = {
    value: null
};
function Tr(t, e) {
    ...
    const c = {
        ...
        process: h => {
            ...
            [n,s] = [s, n],
            n.forEach(u),
            e && pn.value && pn.value.frameloop[e].push(l),
            l = 0,
            n.clear(),
            i = !1,
            o && (o = !1,
...
function _s(t, e) {
    ...
    const i = {
      ...
      , o = () => n = !0
      , r = Bt.reduce( (g, v) => (g[v] = Tr(o, e ? v : void 0),
    g), {})
      , {read: a, resolveKeyframes: l, update: u, preRender: c, render: h, postRender: f} = r
      , d = () => {
        const g = performance.now();
        n = !1,
        i.delta = s ? 1e3 / 60 : Math.max(Math.min(g - i.timestamp, Pr), 1),
        i.timestamp = g,
        i.isProcessing = !0,
        a.process(i),
        l.process(i),
    ...
    ;
    return {
        schedule: Bt.reduce( (g, v) => {
            const x = r[v];
            return g[v] = (b, P=!1, w=!1) => (n || m(),
            x.schedule(b, P, w)),
            g
        }
        , {}),
        cancel: g => {
            for (let v = 0; v < Bt.length; v++)
                r[Bt[v]].cancel(g)
        }
        ,
        state: i,
...
const {schedule: V, cancel: Y, state: E, steps: Qt} = _s(typeof requestAnimationFrame < "u" ? requestAnimationFrame : I, !0)
  , {schedule: Ne} = _s(queueMicrotask, !1);
let It;
function Sr() {
    It = void 0
}
const K = {
    now: () => (It === void 0 && K.set(E.isProcessing || mr.useManualTiming ? E.timestamp : performance.now()),
    It),
    set: t => {
        It = t,
        queueMicrotask(Sr)
...
const Ks = (t, e) => e ? t === e ? !0 : Ks(t, e.parentElement) : !1
  , Ue = t => t.pointerType === "mouse" ? typeof t.button != "number" || t.button <= 0 : t.isPrimary !== !1
  , Vr = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]);
function Cr(t) {
    return Vr.has(t.tagName) || t.tabIndex !== -1
}
...
function Mr(t, e, n={}) {
      ...
      , r = a => {
        ...
        const u = e(l, a)
          , c = (d, m) => {
            ...
            !(!vn(d) || !vt.has(l)) && (vt.delete(l),
            typeof u == "function" && u(d, {
                success: m
            }))
        }
          , h = d => {
            c(d, l === window || l === document || n.useGlobalTarget || Ks(l, d.target))
        }
          , f = d => {
            c(d, !1)
        }
    ...
    return s.forEach(a => {
        ...
        a instanceof HTMLElement && (a.addEventListener("focus", u => Dr(u, i)),
        !Cr(a) && a.tabIndex === null && (a.tabIndex = 0))
    }
    ),
    o
}
const xn = 30
  , Rr = t => !isNaN(parseFloat(t));
class Er {
    constructor(e, n={}) {
        this.version = "12.6.1",
    ...
    setCurrent(e) {
        ...
        this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = Rr(this.current))
    }
...
const Fr = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "custom", "inherit", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "globalTapTarget", "ignoreStrict", "viewport"]);
function Ut(t) {
    return t.startsWith("while") || t.startsWith("drag") && t !== "draggable" || t.startsWith("layout") || t.startsWith("onTap") || t.startsWith("onPan") || t.startsWith("onLayout") || Fr.has(t)
}
let $s = t => !Ut(t);
function Br(t) {
    t && ($s = e => e.startsWith("on") ? !Ut(e) : t(e))
}
try {
...
function kr(t, e, n) {
    const s = {};
    for (const i in t)
        i === "values" && typeof t.values == "object" || ($s(i) || n === !0 && Ut(i) || !e && !Ut(i) || t.draggable && i.startsWith("onDrag")) && (s[i] = t[i]);
    return s
}
function Or(t) {
    if (typeof Proxy > "u")
...
const Ke = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"]
  , We = ["initial", ...Ke];
function Xt(t) {
    return zt(t.animate) || We.some(e => bt(t[e]))
}
function Gs(t) {
...
function jr(t) {
    const {initial: e, animate: n} = Ir(t, S.useContext(Ht));
    return S.useMemo( () => ({
        initial: e,
        animate: n
    }), [Pn(e), Pn(n)])
...
const _r = Symbol.for("motionComponentSymbol");
function rt(t) {
...
const $e = t => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase()
  , Ur = "framerAppearId"
  , Hs = "data-" + $e(Ur)
  , zs = S.createContext({});
function Kr(t, e, n, s, i) {
    var o, r;
    const {visualElement: a} = S.useContext(Ht)
      , l = S.useContext(Ws)
      , u = S.useContext(Le)
      , c = S.useContext(Ls).reducedMotion
      , h = S.useRef(null);
    s = s || l.renderer,
    ...
    const f = h.current
      , d = S.useContext(zs);
    f && !f.projection && i && (f.type === "html" || f.type === "svg") && Wr(h.current, n, i, d);
    const m = S.useRef(!1);
    ...
    const p = n[Hs]
      , y = S.useRef(!!p && !(!((o = window.MotionHandoffIsComplete) === null || o === void 0) && o.call(window, p)) && ((r = window.MotionHasOptimisedAnimation) === null || r === void 0 ? void 0 : r.call(window, p)));
    return fr( () => {
        f && (m.current = !0,
...
function $r({preloadedFeatures: t, createVisualElement: e, useRender: n, useVisualState: s, Component: i}) {
    var o, r;
    t && Lr(t);
    function a(u, c) {
        let h;
        ...
        if (!d && Ee) {
            ...
            const y = zr(f);
            h = y.MeasureLayout,
            m.visualElement = Kr(i, p, f, e, y.ProjectionNode)
        }
        return he.jsxs(Ht.Provider, {
            value: m,
            children: [h && m.visualElement ? he.jsx(h, {
                visualElement: m.visualElement,
                ...f
            }) : null, n(i, u, Nr(p, m.visualElement, c), p, d, m.visualElement)]
        })
    }
...
function Gr({layoutId: t}) {
    const e = S.useContext(Es).id;
    return e && t !== void 0 ? e + "-" + t : t
}
function Hr(t, e) {
    S.useContext(Ws).strict
}
function zr(t) {
...
function qr(t) {
    for (const e in t)
        wt[e] = t[e],
        Ge(e) && (wt[e].isCSSVariable = !0)
}
const dt = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"]
  , st = new Set(dt);
...
function Xe(t, e, n) {
    ...
    if (e.transform || (r || n ? s.transform = so(e, t.transform, n) : s.transform && (s.transform = "none")),
    a) {
...
function Js(t, e, n) {
    for (const s in e)
        !F(e[s]) && !qs(s, n) && (t[s] = e[s])
}
function io({transformTemplate: t}, e) {
    return S.useMemo( () => {
        const n = Ye();
        return Xe(n, e, t),
...
function qe(t) {
    return typeof t != "string" || t.includes("-") ? !1 : !!(ao.indexOf(t) > -1 || /[A-Z]/u.test(t))
}
const lo = {
...
function Ze(t, {attrX: e, attrY: n, attrScale: s, originX: i, originY: o, pathLength: r, pathSpacing: a=1, pathOffset: l=0, ...u}, c, h) {
    if (Xe(t, u, h),
    c) {
    ...
    delete f.transform),
    m && (i !== void 0 || o !== void 0 || d.transform) && (d.transformOrigin = ho(m, i !== void 0 ? i : .5, o !== void 0 ? o : .5)),
    e !== void 0 && (f.x = e),
    n !== void 0 && (f.y = n),
    s !== void 0 && (f.scale = s),
    r !== void 0 && co(f, r, a, l, !1)
}
const Qs = () => ({
    ...Ye(),
    attrs: {}
...
function fo(t, e, n, s) {
    const i = S.useMemo( () => {
        const o = Qs();
        return Ze(o, e, Je(s), t.transformTemplate),
        {
            ...o.attrs,
            style: {
                ...o.style
...
function mo(t=!1) {
    return (n, s, i, {latestValues: o}, r) => {
        const l = (qe(n) ? fo : oo)(s, o, r, n)
          , u = kr(s, typeof n == "string", t)
          , c = n !== S.Fragment ? {
            ...u,
            ...l,
            ref: i
...
const me = t => Array.isArray(t)
  , po = t => !!(t && typeof t == "object" && t.mix && t.toValue)
  , go = t => me(t) ? t[t.length - 1] || 0 : t;
function jt(t) {
    const e = F(t) ? t.get() : t;
    return po(e) ? e.toValue() : e
}
function yo({scrapeMotionValuesFromProps: t, createRenderState: e, onUpdate: n}, s, i, o) {
    const r = {
        latestValues: vo(s, i, o, t),
        renderState: e()
    };
...
function vo(t, e, n, s) {
    ...
    const l = Xt(t)
      , u = Gs(t);
    e && u && !l && t.inherit !== !1 && (r === void 0 && (r = e.initial),
...
function tn(t, e, n) {
    ...
    const {style: i} = t
      , o = {};
    for (const r in i)
        (F(i[r]) || e.style && F(e.style[r]) || qs(r, t) || ((s = n == null ? void 0 : n.getValue(r)) === null || s === void 0 ? void 0 : s.liveStyle) !== void 0) && (o[r] = i[r]);
    return o
}
const xo = {
    useVisualState: ti({
...
function ii(t, e, n, s) {
    ...
    for (const i in e.attrs)
        t.setAttribute(si.has(i) ? i : $e(i), e.attrs[i])
}
function ri(t, e, n) {
    const s = tn(t, e, n);
    for (const i in t)
...
const Vn = ["x", "y", "width", "height", "cx", "cy", "r"]
  , To = {
    useVisualState: ti({
        ...
        onUpdate: ({props: t, prevProps: e, current: n, renderState: s, latestValues: i}) => {
            ...
            r && V.read( () => {
                ei(n, s),
                V.render( () => {
                    Ze(s, i, Je(n.tagName), t.transformTemplate),
                    ii(n, s)
                }
                )
            }
...
const oi = new Set(["width", "height", "top", "left", "right", "bottom", ...dt]);
function So(t, e, n) {
...
const li = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t
  , wo = 1e-7
  , Vo = 12;
...
const ui = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2
  , ci = t => e => 1 - t(1 - e)
  , hi = Et(.33, 1.53, .69, .99)
  , en = ci(hi)
  , fi = ui(en)
  , di = t => (t *= 2) < 1 ? .5 * en(t) : .5 * (2 - Math.pow(2, -10 * (t - 1)))
...
const Ro = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu
  , rn = (t, e) => n => !!(typeof n == "string" && Ro.test(n) && n.startsWith(t) || e && !Mo(n) && Object.prototype.hasOwnProperty.call(n, e))
  , yi = (t, e, n) => s => {
    if (typeof s != "string")
        return s;
  ...
  , tt = {
    ...
    transform: ({red: t, green: e, blue: n, alpha: s=1}) => "rgba(" + ee.transform(t) + ", " + ee.transform(e) + ", " + ee.transform(n) + ", " + xt(Vt.transform(s)) + ")"
};
function Lo(t) {
    let e = ""
      , n = ""
...
const ge = {
  ...
  , ot = {
    ...
    transform: ({hue: t, saturation: e, lightness: n, alpha: s=1}) => "hsla(" + Math.round(t) + ", " + W.transform(xt(e)) + ", " + W.transform(xt(n)) + ", " + xt(Vt.transform(s)) + ")"
}
  , L = {
    test: t => tt.test(t) || ge.test(t) || ot.test(t),
    parse: t => tt.test(t) ? tt.parse(t) : ot.test(t) ? ot.parse(t) : ge.parse(t),
    transform: t => typeof t == "string" ? t : t.hasOwnProperty("red") ? tt.transform(t) : ot.transform(t)
}
  , Fo = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;
function Bo(t) {
    var e, n;
    return isNaN(t) && typeof t == "string" && (((e = t.match(sn)) === null || e === void 0 ? void 0 : e.length) || 0) + (((n = t.match(Fo)) === null || n === void 0 ? void 0 : n.length) || 0) > 0
}
const vi = "number"
  , xi = "color"
  , ko = "var"
...
function Dt(t) {
    const e = t.toString()
      ...
      , i = [];
    let o = 0;
    const a = e.replace(Io, l => (L.test(l) ? (s.color.push(o),
    i.push(xi),
    n.push(L.parse(l))) : l.startsWith(Oo) ? (s.var.push(o),
    i.push(ko),
...
function Pi(t) {
    ...
    return i => {
        ...
        for (let r = 0; r < s; r++)
            ...
            i[r] !== void 0) {
                const a = n[r];
                a === vi ? o += xt(i[r]) : a === xi ? o += L.transform(i[r]) : o += i[r]
            }
        return o
    }
}
const jo = t => typeof t == "number" ? 0 : t;
function _o(t) {
    const e = Ti(t);
    return Pi(t)(e.map(jo))
}
const q = {
    test: Bo,
    parse: Ti,
  ...
  , No = new Set(["brightness", "contrast", "saturate", "opacity"]);
function Uo(t) {
...
const $o = new Set(["auto", "none", "0"]);
function Go(t, e, n) {
    let s = 0, i;
    for (; s < t.length && !i; ) {
        const o = t[s];
        typeof o == "string" && !$o.has(o) && Dt(o).values.length && (i = t[s]),
        s++
    }
    if (i && n)
        for (const o of e)
...
t)
  ...
  , zo = {
    ...
    scaleY: Rn,
    scale: t => (Mn(t) + Rn(t)) / 2,
    rotateX: t => xe(et(Math.atan2(t[6], t[5]))),
    rotateY: t => xe(et(Math.atan2(-t[2], t[0]))),
    rotateZ: Dn,
    rotate: Dn,
...
function bi() {
    ...
    Se = !1,
    Pe = !1,
    nt.forEach(t => t.complete()),
    nt.clear()
}
function wi() {
    nt.forEach(t => {
        t.readKeyframes(),
        t.needsMeasurement && (Se = !0)
    }
    )
}
function Qo() {
...
class on {
    ...
    scheduleResolve() {
        this.isScheduled = !0,
        this.isAsync ? (nt.add(this),
        Pe || (Pe = !0,
        V.read(wi),
        V.resolveKeyframes(bi))) : (this.readKeyframes(),
        this.complete())
    }
    readKeyframes() {
...
function ia(t, e, n, s) {
    ...
    const o = t[t.length - 1]
      , r = Bn(i, e)
      , a = Bn(o, e);
    return !r || !a ? !1 : sa(t) || (n === "spring" || je(n)) && s
}
const ra = t => t !== null;
...
class Ei {
    ...
    get resolved() {
        return !this._resolved && !this.hasAttemptedResolve && Qo(),
        this._resolved
    }
...
const On = (t, e) => {
    ...
    return o => (i.red = se(n.red, s.red, o),
...
function an(t) {
    return typeof t == "number" ? fa : typeof t == "string" ? He(t) ? Kt : L.test(t) ? On : pa : Array.isArray(t) ? Li : typeof t == "object" ? L.test(t) ? On : da : Kt
}
function Li(t, e) {
    const n = [...t]
      , s = n.length
...
const pa = (t, e) => {
    const n = q.createTransformer(e)
      , s = Dt(t)
      , i = Dt(e);
    return s.indexes.var.length === i.indexes.var.length && s.indexes.color.length === i.indexes.color.length && s.indexes.number.length >= i.indexes.number.length ? Ae.has(t) && !i.values.length || Ae.has(e) && !s.values.length ? ha(t, e) : Lt(Li(ma(s, i), i.values), n) : Kt(t, e)
}
;
function Fi(t, e, n) {
    return typeof t == "number" && typeof e == "number" && typeof n == "number" ? C(t, e, n) : an(t)(t, e)
}
const ga = 5;
function Bi(t, e, n) {
...
const D = {
  ...
  , In = .001;
function ya({duration: t=D.duration, bounce: e=D.bounce, velocity: n=D.velocity, mass: s=D.mass}) {
    let i, o, r = 1 - e;
    r = z(D.minDamping, D.maxDamping, r),
    t = z(D.minDuration, D.maxDuration, H(t)),
    r < 1 ? (i = u => {
        const c = u * r
          , h = c * t
          , f = c - n
...
function ki(t=D.visualDuration, e=D.bounce) {
    ...
    const o = n.keyframes[0]
      ...
      , {stiffness: l, damping: u, mass: c, duration: h, velocity: f, isResolvedFromDuration: d} = Sa({
        ...n,
    ...
    const b = {
        ...
        next: P => {
            ...
            if (d)
                ...
                let R = 0;
                p < 1 && (R = P === 0 ? G(m) : Bi(x, P, w));
                const A = Math.abs(R) <= s
                  , O = Math.abs(r - w) <= i;
                a.done = A && O
            }
            return a.value = a.done ? r : w,
            a
        }
        ,
        toString: () => {
            const P = Math.min(ks(b), fe)
              , w = Os(R => b.next(P * R).value, P, 30);
            return P + "ms " + w
        }
    };
    return b
}
function _n({keyframes: t, velocity: e=0, power: n=.8, timeConstant: s=325, bounceDamping: i=10, bounceStiffness: o=500, modifyTarget: r, min: a, max: l, restDelta: u=.5, restSpeed: c}) {
    const h = t[0]
      , f = {
        done: !1,
        value: h
    ...
    return R(0),
    {
        ...
        next: A => {
            let O = !1;
            return !w && P === void 0 && (O = !0,
            b(A),
            R(A)),
            P !== void 0 && A >= P ? w.next(A - P) : (!O && b(A),
            f)
        }
    }
}
const Aa = Et(.42, 0, 1, 1)
  , ba = Et(0, 0, .58, 1)
  , Oi = Et(.42, 0, .58, 1)
...
const Fa = t => {
    ...
    return {
        start: () => V.update(e, !0),
        stop: () => Y(e),
        now: () => E.isProcessing ? E.timestamp : K.now()
    }
}
  , Ba = {
    decay: _n,
...
class ln extends Ei {
    constructor(e) {
        ...
        const {name: n, motionValue: s, element: i, keyframes: o} = this.options
          , r = (i == null ? void 0 : i.KeyframeResolver) || on
    ...
    initPlayback(e) {
        const {type: n="keyframes", repeat: s=0, repeatDelay: i=0, repeatType: o, velocity: r=0} = this.options
          , a = je(n) ? n : Ba[n] || Wt;
        let l, u;
        a !== Wt && typeof e[0] != "number" && (l = Lt(ka, Fi(e[0], e[1])),
        e = [0, 100]);
        const c = a({
            ...this.options,
            keyframes: e
        ...
        c.calculatedDuration === null && (c.calculatedDuration = ks(c));
    ...
    tick(e, n=!1) {
        ...
        return R && i !== void 0 && (P.value = Yt(l, this.options, i)),
        y && y(P.value),
        R && this.finish(),
        P
    }
    ...
    set speed(e) {
        ...
        n && (this.time = H(this.currentTime))
    }
    play() {
        ...
        if (this.isStopped)
            return;
        const {driver: e=Fa, onPlay: n, startTime: s} = this.options;
...
const Oa = new Set(["opacity", "clipPath", "filter", "transform"]);
function Ia(t, e, n, {delay: s=0, duration: i=300, repeat: o=0, repeatType: r="loop", ease: a="easeInOut", times: l}={}) {
    const u = {
        [e]: n
    };
    l && (u.offset = l);
...
const ja = ke( () => Object.hasOwnProperty.call(Element.prototype, "animate"))
  , $t = 10
  , _a = 2e4;
function Na(t) {
    return je(t.type) || t.type === "spring" || !Is(t.ease)
}
function Ua(t, e) {
    const n = new ln({
        ...e,
...
class Un extends Ei {
    ...
    initPlayback(e, n) {
        ...
        if (!a.owner || !a.owner.current)
            return !1;
        if (typeof o == "string" && Nt() && Ka(o) && (o = Ii[o]),
        Na(this.options)) {
        ...
        const c = Ia(a.owner.current, l, e, {
            ...this.options,
            duration: s,
            times: i,
            ease: o
        ...
        this.pendingTimeline ? (mn(c, this.pendingTimeline),
    ...
    static supports(e) {
        ...
        return ja() && s && Oa.has(s) && (s !== "transform" || !u) && !l && !i && o !== "mirror" && r !== 0 && a !== "inertia"
    }
}
const Wa = {
    type: "spring",
  ...
  , za = (t, {keyframes: e}) => e.length > 2 ? Ga : st.has(t) ? t.startsWith("scale") ? $a(e[1]) : Wa : Ha;
function Xa({when: t, delay: e, delayChildren: n, staggerChildren: s, staggerDirection: i, repeat: o, repeatType: r, repeatDelay: a, from: l, elapsed: u, ...c}) {
...
const un = (t, e, n, s={}, i, o) => r => {
    ...
    return !o && Un.supports(c) ? new Un(c) : new ln(c)
}
;
    ...
    for (const h in l) {
        ...
        if (window.MotionHandoffAnimation) {
            ...
            if (g) {
                ...
                v !== null && (m.startTime = v,
                p = !0)
            }
        }
        pe(t, h),
        f.start(un(h, f, d, t.shouldReduceMotion && oi.has(h) ? {
            type: !1
        } : m, t, p));
        const y = f.animation;
        y && u.push(y)
...
function we(t, e, n={}) {
    ...
    const r = i ? () => Promise.all(ji(t, i, n)) : () => Promise.resolve()
...
function sl(t) {
    ...
    function r(l) {
        ...
        for (let y = 0; y < el; y++) {
            ...
            P === !1 && (m = y);
            let w = x === c[g] && x !== u[g] && b;
            if (w && s && t.manuallyAnimateOnMount && (w = !1),
            v.protectedKeys = {
                ...d
            },
            !v.isActive && P === null || !x && !v.prevProp || zt(x) || typeof x == "boolean")
                continue;
            const R = il(v.prevProp, x);
            ...
            for (const B in ar) {
                ...
                if (d.hasOwnProperty(B))
                    continue;
                let Zt = !1;
                me($) && me(qt) ? Zt = !_i($, qt) : Zt = $ !== qt,
                Zt ? $ != null ? hn(B) : f.add(B) : $ !== void 0 && f.has(B) ? hn(B) : v.protectedKeys[B] = !0
            }
            v.prevProp = x,
        ...
        let p = !!h.length;
        return s && (u.initial === !1 || u.initial === u.animate) && !t.manuallyAnimateOnMount && (p = !1),
        s = !1,
...
const ul = t => e => Ue(e) && t(e, Ft(e));
function Tt(t, e, n, s) {
    return Mt(t, e, ul(n), s)
}
...
function Q(t) {
    return Ve(t) || $i(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY
}
function $i(t) {
...
function Jn(t, e, n, s, i=.5) {
    const o = C(t.min, t.max, i);
    Ce(t, e, n, o, s)
}
function ut(t, e) {
    Jn(t.x, e.x, e.scaleX, e.scale, e.originX),
    Jn(t.y, e.y, e.scaleY, e.scale, e.originY)
}
function Hi(t, e) {
    return Ui(hl(t.getBoundingClientRect(), e))
}
function xl(t, e, n) {
    const s = Hi(t, n)
      , {scroll: i} = e;
    return i && (lt(s.x, i.offset.x),
    lt(s.y, i.offset.y)),
    s
}
const zi = ({current: t}) => t ? t.ownerDocument.defaultView : null
  , Qn = (t, e) => Math.abs(t - e);
function Tl(t, e) {
    const n = Qn(t.x, e.x)
      , s = Qn(t.y, e.y);
...
class Xi {
    constructor(e, n, {transformPagePoint: s, contextWindow: i, dragSnapToOrigin: o=!1}={}) {
        ...
        this.handlePointerMove = (h, f) => {
            ...
            this.lastMoveEventInfo = re(f, this.transformPagePoint),
        ...
        const r = Ft(e)
          , a = re(r, this.transformPagePoint)
          , {point: l} = a
          , {timestamp: u} = E;
        this.history = [{
            ...l,
        ...
        c && c(e, oe(a, this.history)),
        this.removeListeners = Lt(Tt(this.contextWindow, "pointermove", this.handlePointerMove), Tt(this.contextWindow, "pointerup", this.handlePointerUp), Tt(this.contextWindow, "pointercancel", this.handlePointerUp))
    }
    updateHandlers(e) {
        this.handlers = e
    }
...
function bl(t, {top: e, left: n, bottom: s, right: i}) {
    return {
        x: es(t.x, n, i),
        y: es(t.y, e, s)
    }
...
function Vl(t, e) {
    ...
    const s = k(t)
      , i = k(e);
    return i > s ? n = ct(e.min, e.max - s, t.min) : s > i && (n = ct(t.min, t.max - i, e.min)),
    z(0, 1, n)
}
function Cl(t, e) {
    const n = {};
...
class Rl {
    ...
    start(e, {snapToCursor: n=!1}={}) {
        ...
        const i = c => {
            ...
            n && this.snapToCursor(Ft(c).point)
        }
          , o = (c, h) => {
            const {drag: f, dragPropagation: d, onDragStart: m} = this.getProps();
            if (f && !d && (this.openDragLock && this.openDragLock(),
            this.openDragLock = Ar(f),
            !this.openDragLock))
                return;
            this.isDragging = !0,
            this.currentDirection = null,
    ...
    updateAxis(e, n, s) {
        ...
        this.constraints && this.constraints[e] && (r = Al(r, this.constraints[e], this.elastic[e])),
        o.set(r)
    }
    resolveConstraints() {
        var e;
        const {dragConstraints: n, dragElastic: s} = this.getProps()
          ...
          , o = this.constraints;
        n && rt(n) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : n && i ? this.constraints = bl(i.layoutBox, n) : this.constraints = !1,
        this.elastic = Dl(s),
        o !== this.constraints && i && this.constraints && !this.hasMutatedConstraints && N(r => {
            this.constraints !== !1 && this.getAxisMotionValue(r) && (this.constraints[r] = Cl(i.layoutBox[r], this.constraints[r]))
        }
        )
    }
    ...
    startAxisValueAnimation(e, n) {
        ...
        return pe(this.visualElement, e),
        s.start(un(e, s, 0, n, this.visualElement, !1))
    }
    stopAnimation() {
    ...
    addListeners() {
        ...
        const r = Mt(window, "resize", () => this.scalePositionWithinConstraints())
          , a = i.addEventListener("didUpdate", ({delta: l, hasLayoutChanged: u}) => {
            this.isDragging && u && (N(c => {
                const h = this.getAxisMotionValue(c);
                h && (this.originPoint[c] += l[c].translate,
    ...
    getProps() {
        const e = this.visualElement.getProps()
          , {drag: n=!1, dragDirectionLock: s=!1, dragPropagation: i=!1, dragConstraints: o=!1, dragElastic: r=De, dragMomentum: a=!0} = e;
        return {
            ...e,
            drag: n,
            dragDirectionLock: s,
...
class Fl extends Z {
    ...
    onPointerDown(e) {
        this.session = new Xi(e,this.createPanHandlers(),{
...
const gt = {
  ...
  , Bl = {
    correct: (t, {treeScale: e, projectionDelta: n}) => {
        ...
        i[1 + r] /= l;
        const u = C(a, l, .5);
        return typeof i[2 + r] == "number" && (i[2 + r] /= u),
        typeof i[3 + r] == "number" && (i[3 + r] /= u),
        o(i)
    }
};
class kl extends S.Component {
    componentDidMount() {
    ...
    getSnapshotBeforeUpdate(e) {
        ...
        e.isPresent !== o && (o ? r.promote() : r.relegate() || V.postRender( () => {
            const a = r.getStack();
...
function qi(t) {
    ...
    return he.jsx(kl, {
        ...t,
        layoutGroup: s,
        switchLayoutGroup: S.useContext(zs),
        isPresent: e,
        safeToRemove: n
    })
}
...
class Nl {
    ...
    forEach(e) {
        this.isDirty && this.children.sort(_l),
        this.isDirty = !1,
...
const Zi = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"]
  ...
  , ls = t => typeof t == "number" || T.test(t);
function Wl(t, e, n, s, i, o) {
    i ? (t.opacity = C(0, n.opacity !== void 0 ? n.opacity : 1, $l(s)),
    t.opacityExit = C(e.opacity !== void 0 ? e.opacity : 1, 0, Gl(s))) : o && (t.opacity = C(e.opacity !== void 0 ? e.opacity : 1, n.opacity !== void 0 ? n.opacity : 1, s));
    for (let r = 0; r < Kl; r++) {
        ...
        l || (l = 0),
        u || (u = 0),
        l === 0 || u === 0 || ls(l) === ls(u) ? (t[a] = Math.max(C(as(l), as(u), s), 0),
        (W.test(u) || W.test(l)) && (t[a] += "%")) : t[a] = u
    }
...
function fs(t, e, n, s, i) {
    return t -= e,
    t = Gt(t, 1 / n, s),
    i !== void 0 && (t = Gt(t, 1 / i, s)),
    t
}
function Hl(t, e=0, n=1, s=.5, i, o=t, r=t) {
...
function ds(t, e, [n,s,i], o, r) {
    Hl(t, e[n], e[s], e[i], e.scale, o, r)
}
const zl = ["x", "scaleX", "originX"]
  , Xl = ["y", "scaleY", "originY"];
function ms(t, e, n, s) {
    ds(t.x, e, zl, n ? n.x : void 0, s ? s.x : void 0),
    ds(t.y, e, Xl, n ? n.y : void 0, s ? s.y : void 0)
}
function ps(t) {
...
function nr({attachResizeListener: t, defaultParent: e, measureScroll: n, checkIsScrollRoot: s, resetTransform: i}) {
    return class {
        ...
        addEventListener(r, a) {
            return this.eventHandlers.has(r) || this.eventHandlers.set(r, new Oe),
        ...
        mount(r, a=this.root.hasTreeAnimated) {
            ...
            t) {
                ...
                t(r, () => {
                    ...
                    h && h(),
                    h = Ul(f, 250),
                    _t.hasAnimatedSinceResize && (_t.hasAnimatedSinceResize = !1,
                    this.nodes.forEach(Ss))
                }
                )
            }
            l && this.root.registerSharedNode(l, this),
            this.options.animate !== !1 && c && (l || u) && this.addEventListener("didUpdate", ({delta: h, hasLayoutChanged: f, hasRelativeLayoutChanged: d, layout: m}) => {
                if (this.isTreeAnimationBlocked()) {
                    this.target = void 0,
                    this.relativeTarget = void 0;
                    return
                }
                const p = this.options.transition || c.getDefaultTransition() || du
                  , {onLayoutAnimationStart: y, onLayoutAnimationComplete: g} = c.getProps()
                  , v = !this.targetLayout || !tr(this.targetLayout, m)
                  , x = !f && d;
                if (this.options.layoutRoot || this.resumeFrom || x || f && (v || !this.currentAnimation)) {
                    ...
                    (c.shouldReduceMotion || this.options.layoutRoot) && (b.delay = 0,
                    b.type = !1),
        ...
        startUpdate() {
            ...
            this.nodes && this.nodes.forEach(uu),
            this.animationId++)
        }
        ...
        willUpdate(r=!0) {
            ...
            if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && er(this),
        ...
        update() {
            ...
            E.isProcessing = !0,
            Qt.update.process(E),
            Qt.preRender.process(E),
            Qt.render.process(E),
            E.isProcessing = !1
        }
        didUpdate() {
            this.updateScheduled || (this.updateScheduled = !0,
            Ne.read(this.scheduleUpdate))
        }
        clearAllSnapshots() {
        ...
        updateSnapshot() {
            ...
            this.snapshot && !k(this.snapshot.measuredBox.x) && !k(this.snapshot.measuredBox.y) && (this.snapshot = void 0))
        }
        updateLayout() {
        ...
        resetTransform() {
            ...
            r && (a || Q(this.latestValues) || c) && (i(this.instance, u),
            this.shouldResetTransform = !1,
            this.scheduleRender())
        }
        measure(r=!0) {
        ...
        removeElementScroll(r) {
            ...
            for (let u = 0; u < this.path.length; u++) {
                ...
                c !== this.root && h && f.layoutScroll && (h.wasRoot && _(l, r),
                lt(l.x, h.offset.x),
                lt(l.y, h.offset.y))
            }
            return l
        ...
        applyTransform(r, a=!1) {
            ...
            return Q(this.latestValues) && ut(l, this.latestValues),
            l
        }
        removeTransform(r) {
            const a = M();
            ...
            for (let l = 0; l < this.path.length; l++) {
                const u = this.path[l];
                if (!u.instance || !Q(u.latestValues))
                    continue;
                Ve(u.latestValues) && u.updateSnapshot();
                const c = M()
                  , h = u.measurePageBox();
                _(c, h),
                ms(a, u.latestValues, u.snapshot ? u.snapshot.layoutBox : void 0, c)
            }
            return Q(this.latestValues) && ms(a, this.latestValues),
            a
        }
        setTargetDelta(r) {
            this.targetDelta = r,
        ...
        resolveTargetDelta(r=!1) {
            ...
            if (!(!this.layout || !(h || f))) {
                ...
                !this.targetDelta && !this.relativeTarget) {
                    ...
                    St(this.relativeTargetOrigin, this.layout.layoutBox, d.layout.layoutBox),
                    _(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                }
                if (!(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = M(),
                this.targetWithTransforms = M()),
                this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(),
                yl(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : _(this.target, this.layout.layoutBox),
                Gi(this.target, this.targetDelta)) : _(this.target, this.layout.layoutBox),
        ...
        getClosestProjectingParent() {
            if (!(!this.parent || Ve(this.parent.latestValues) || $i(this.parent.latestValues)))
        ...
        calcProjection() {
            ...
            let u = !0;
            if ((this.isProjectionDirty || !((r = this.parent) === null || r === void 0) && r.isProjectionDirty) && (u = !1),
            ...
            !this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (hs(this.prevProjectionDelta.x, this.projectionDelta.x),
            hs(this.prevProjectionDelta.y, this.projectionDelta.y)),
            Pt(this.projectionDelta, this.layoutCorrected, m, this.latestValues),
            (this.treeScale.x !== f || this.treeScale.y !== d || !xs(this.projectionDelta.x, this.prevProjectionDelta.x) || !xs(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0,
            this.scheduleRender(),
        ...
        setAnimationOrigin(r, a=!1) {
            ...
            const f = M()
              ...
              , v = !!(p && !g && this.options.crossfade === !0 && !this.path.some(fu));
            this.animationProgress = 0;
            let x;
            this.mixTargetDelta = b => {
                ...
                this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (St(f, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
                hu(this.relativeTarget, this.relativeTargetOrigin, f, P),
                x && Yl(this.relativeTarget, x) && (this.isProjectionDirty = !1),
                x || (x = M()),
                _(x, this.relativeTarget)),
                p && (this.animationValues = c,
                Wl(c, u, this.latestValues, P, v, g)),
                this.root.scheduleUpdateProjection(),
                this.scheduleRender(),
        ...
        startAnimation(r) {
            ...
            this.pendingAnimation = V.update( () => {
                _t.hasAnimatedSinceResize = !0,
                this.currentAnimation = Il(0, Ts, {
                    ...r,
                    onUpdate: a => {
        ...
        registerSharedNode(r, a) {
            this.sharedNodes.has(r) || this.sharedNodes.set(r, new ql),
        ...
        resetSkewAndRotation() {
            ...
            for (let c = 0; c < ae.length; c++)
                le(`rotate${ae[c]}`, r, u, this.animationValues),
                le(`skew${ae[c]}`, r, u, this.animationValues);
            r.render();
            for (const c in u)
        ...
        getProjectionStyles(r) {
            ...
            if (this.needsReset)
                ...
                u.opacity = "",
                u.pointerEvents = jt(r == null ? void 0 : r.pointerEvents) || "",
            ...
            if (!this.projectionDelta || !this.layout || !h.target) {
                ...
                p.pointerEvents = jt(r == null ? void 0 : r.pointerEvents) || ""),
                this.hasProjected && !Q(this.latestValues) && (p.transform = c ? c({}, "") : "none",
                this.hasProjected = !1),
                p
            }
            const f = h.animationValues || h.latestValues;
            this.applyTransformsToTarget(),
            u.transform = Zl(this.projectionDeltaWithTransform, this.treeScale, f),
            c && (u.transform = c(f, u.transform));
            const {x: d, y: m} = this.projectionDelta;
            u.transformOrigin = `${d.origin * 100}% ${m.origin * 100}% 0`,
            h.animationValues ? u.opacity = h === this ? (l = (a = f.opacity) !== null && a !== void 0 ? a : this.latestValues.opacity) !== null && l !== void 0 ? l : 1 : this.preserveOpacity ? this.latestValues.opacity : f.opacityExit : u.opacity = h === this ? f.opacity !== void 0 ? f.opacity : "" : f.opacityExit !== void 0 ? f.opacityExit : 0;
            for (const p in wt) {
                if (f[p] === void 0)
                    continue;
                const {correct: y, applyTo: g, isCSSVariable: v} = wt[p]
            ...
            return this.options.layoutId && (u.pointerEvents = h === this ? jt(r == null ? void 0 : r.pointerEvents) || "" : "none"),
            u
        }
        clearSnapshot() {
...
const du = {
  ...
  , Vs = ws("applewebkit/") && !ws("chrome/") ? Math.round : I;
function Cs(t) {
    t.min = Vs(t.min),
    t.max = Vs(t.max)
}
...
function sr(t, e, n) {
    return t === "position" || t === "preserve-aspect" && !gl(vs(e), vs(n), .2)
}
function pu(t) {
    var e;
...
class vu extends Z {
    mount() {
        ...
        e && (this.unmount = wr(e, (n, s) => (Ds(this.node, s, "Start"),
        i => Ds(this.node, i, "End"))))
    }
    unmount() {}
}
class xu extends Z {
...
class Tu extends Z {
    mount() {
        const {current: e} = this.node;
        e && (this.unmount = Mr(e, (n, s) => (Ms(this.node, s, "Start"),
        (i, {success: o}) => Ms(this.node, i, o ? "End" : "Cancel")), {
...
class ku {
    ...
    update(e, n) {
        ...
        this.prevMotionValues = Bu(this, this.scrapeMotionValuesFromProps(e, this.prevProps, this), this.prevMotionValues),
    ...
    getValue(e, n) {
        ...
        return s === void 0 && n !== void 0 && (s = At(n === null ? void 0 : n, {
            owner: this
        }),
        this.addValue(e, s)),
        s
    ...
    readValue(e, n) {
        ...
        return i != null && (typeof i == "string" && (Vi(i) || gi(i)) ? i = parseFloat(i) : !Lu(i) && q.test(n) && (i = Ai(e, n)),
    ...
    on(e, n) {
        return this.events[e] || (this.events[e] = new Oe),
        this.events[e].add(n)
    }
    notify(e, ...n) {
...
const _u = (t, e) => qe(t) ? new ju(e) : new Iu(e,{

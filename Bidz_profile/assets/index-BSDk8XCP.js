...
const Tc = {
    en: {
        ...
        "hero.greeting": "👋 Hello, I am Thanh Loc",
    ...
    vi: {
        ...
        "hero.greeting": "👋 Xin chào, tôi là Thanh Loc",
...
function ks({title: e="Thanh Loc | Lập trình viên trẻ chuyên về tự động hóa & nghiên cứu bảo mật", description: t="Thanh Loc - Lập trình viên trẻ đam mê về tự động hóa, học máy và nghiên cứu bảo mật. Khám phá các dự án sáng tạo và giải pháp công nghệ.", keywords: r="Thanh Loc, Thanh Loc, lập trình viên, tự động hóa, reverse engineering, nghiên cứu bảo mật, Python, JavaScript, blockchain, AI, học máy", ogImage: n="/assets/avata.png", ogUrl: o="https://ngoquangduan.io.vn", ogType: s="website", twitterCard: i="summary_large_image", noIndex: l=!1, canonicalUrl: c, lang: d="vi"}) {
    ...
    return a.jsxs(Cs, {
        ...
        children: [a.jsx("title", {
            ...
            rel: "icon",
            href: "/assets/avata.png"
        })]
    })
}
function id({name: e, description: t, image: r="/assets/avatar.png", url: n="https://ngoquangduan.io.vn", sameAs: o=["https://github.com/hiep-py", "https://www.youtube.com/@LacDev-db2vx"], jobTitle: s="Developer", email: i, phone: l, address: c, type: d="Person"}) {
...
function hd() {
    const {language: e} = Ut()
      , [t,r] = x.useState(!1)
      , n = [{
        title: e === "en" ? "Cisco Certified (CC)" : "Chứng chỉ Cisco (CC)",
        image: "/certificates/AI certificates.png",
        description: e === "en" ? "Cisco certification demonstrating networking proficiency." : "Chứng chỉ Cisco thể hiện năng lực về mạng.",
        orientation: "landscape"
    }, {
        title: e === "en" ? "Google Digital Garage" : "Google Digital Garage",
        image: "/certificates/googledigital.jpg",
        description: e === "en" ? "Google Digital training in digital marketing and fundamentals." : "Đào tạo Google Digital về marketing kỹ thuật số và các kiến thức cơ bản.",
        orientation: "landscape"
    }]
      , o = t ? n : n.slice(0, 2);
...
function fd() {
    const {t: e, language: t} = Ut()
    , r = t === "en" ? "Thanh Loc | Developer" : "Thanh Loc | Lập trình viên"
    , n = t === "en" ? "Thanh Loc - Young developer specializing in automation, reverse engineering and security research. Explore creative projects and technology solutions." : "Thanh Loc - Lập trình viên trẻ chuyên về tự động hóa, reverse engineering và nghiên cứu bảo mật. Khám phá các dự án sáng tạo và giải pháp công nghệ."
    , o = t === "en" ? "Thanh Loc" : "Thanh Loc"
    ...
    return a.jsxs("div", {
        ...
        children: [a.jsx(ks, {
            title: r,
            description: n,
            keywords: "Thanh Loc, Thanh Loc, developer, automation, reverse engineering, security research, TikTok automation, EXE2PY, tooldecexe"
        }), a.jsx(id, {
            type: "Person",
            name: o,
            jobTitle: s,
            ...
            children: a.jsxs("div", {
                ...
                children: [a.jsxs("div", {
                    ...
                    children: [a.jsxs("div", {
                        ...
                        children: [a.jsx("h3", {
                            ...
                            children: [a.jsx("a", {
                                ...
                                children: "ngoquangduanvn1708@gmail.com"
                            }), a.jsx("a", {
                                href: "https://github.com/hiep-py",
                                target: "_blank",
                                rel: "noopener noreferrer",
                                className: "text-sm text-muted-foreground hover:text-primary transition-colors block",
                                children: "github.com/hiep-py"
                            }), a.jsx("a", {
                                href: "https://www.youtube.com/@LacDev-db2vx",
                                target: "_blank",
                                rel: "noopener noreferrer",
                                className: "text-sm text-muted-foreground hover:text-primary transition-colors block",
                                children: "youtube.com/@LacDev-db2vx"
                            })]
                        })]
                    })]
                }), a.jsx("div", {
                    ...
                    children: a.jsxs("p", {
                        className: "text-sm text-muted-foreground",
                        children: ["© ", new Date().getFullYear(), " Thanh Loc. ", t === "en" ? "All rights reserved." : "Mọi quyền được bảo lưu."]
                    })
                })]
            })
        })]
...
const pd = () => {
    ...
    a.jsxs("div", {
        ...
        children: [a.jsx(ks, {
            title: "404 - Không tìm thấy trang | Thanh Loc",
